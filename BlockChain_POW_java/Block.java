...
/**
 * The class that creates the blocks that keep record of all trasactions in the
 * blockchain.
...
public class Block {
     ...
     * 
     * @param transactionData   the transaction data stored in the block and used to
     *                          generate a unique hash
     * @param previousBlockHash the SHA-256 hash string of the previous block in the
     *                          chain
     */
     ...
     * 
     * @return a String storing the block transaction data that was used in the hash
     *         function
     */
