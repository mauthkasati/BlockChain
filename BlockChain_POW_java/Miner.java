...
public class Miner {
    ...
    /**
     * Constructor of a Miner object takes in the data it needs to create a new
     * block for the Network.
     * Allows for the block to be mined to be set upon object instatiation
     * 
     * @param transactionData   the transaction data String needed to create a new
     *                          block
    ...
    /**
     * This function returns the newly created block ONLY after the mineBlock()
     * method is executed.
     * This will acts as an extremely rudimentary 'proof of work' because the block
     * will not
