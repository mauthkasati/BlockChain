 ...
 * This class will contain a method to verify the chain stored within it is
 * valid
 */
public class BlockChain {
    ...
    /**
     * Constructor that takes an ArrayList of blocks to create the BlockChain
     * object.
     * 
     * @param blockChainList the ArrayList member object that contains all blocks in
     *                       the
     *                       newly created chain
     */
    ...
    /**
     * Adds a block to the ArrayList stored in the BlockChain class and stores last
     * block in the chain.
     * 
     ...
     * 
     * @return The SHA-256 hash value of the previous block stored in the last block
     *         in
     *         the chain
     */
