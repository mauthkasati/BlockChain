...
public class Network {
    ...
    private Miner successfulMiner() {
        /*
         * This method picks a random miner from the list of miners to mine the newest
         * block
         * This is done because this simulation can't simulate the true competition of
         * miners
     ...
     * 
     * @param transactionData the String representing transaction data being input
     *                        into the network
     */
    ...
    private boolean nodeConsensus(Block newlyMinedBlock) {
        ...
        BlockChain previousChain = this.nodes.get(0).getProposedBlockChain(); // assumes there is at least 1 node in the
                                                                              // network
    ...
    protected static void delay(int milliseconds) {
        // this method wraps around the try/catch seen below to add delay to the
        // simulator
        try {
            Thread.sleep(1500);
