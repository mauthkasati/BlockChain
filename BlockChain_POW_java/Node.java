...
public class Node {
    ...
    /**
     * Constructor that initializes the Node with the current valid blockchain and
     * the
     * newly mined block that needs to be verified.
     * 
     * @param currentBlockChain The current valid blockchain, this us the same for
     *                          every block on the network
     * @param minedBlock        The newest mined block that needs to be verified by
    ...
    /**
     * Updates the currently accepted blockchain and the newly mined block so the
     * Node instance
     * can be reused.
     * 
     * @param currentBlockChain The current valid blockchain, this us the same for
    ...
    public void updateNode(BlockChain currentBlockChain, Block minedBlock) {
        // currentValidChain is cloned here to avoid nodes changing each others
        // BlockChains
    ...
    /**
     * Method that ensures a BlockChain object is valid by checking and calculating
     * the hash values of
     * each block. This ensures the the chain and the blocks within it haven't been
     * tampered with.
     * 
