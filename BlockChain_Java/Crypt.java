...
public class Crypt {
	...
	public static String sha256(String input) {
		// using try/catch to handle exceptions can be occured, exactly runtime exception
		try {
			...
			// sha encrypts an input in UTF-8 (encoding system for Unicode), and storing it in an array of bytes
